...
var bot = new builder.UniversalBot(connector,[
    ...
    function (session) {
        builder.Prompts.text("Hello World from " + botenv);
        builder.Prompts.choice(session, "Hello.... What's your preferred language?", 'English|Korean');
    },
    ...
    function (session, result) {
        ...
        builder.Prompts.text("Your preferred language is now %s.", session.userData.language);
    }
...
//        builder.Prompts.choice(session, "What's your preferred language?", 'English|Korean');
//    },
//    function (session, results) {
